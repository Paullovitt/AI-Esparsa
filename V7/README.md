...
- Checkpoint operacional: `modelos/gerador_esparso_v73_bpe8192_5x3000_topologia.pt`
- SHA-256: `0fa1e7fc43dcce7fd7d4561c941c3ee4c3d64ee6a2b41b5e199774a2927c21fa`
...
- Treinamento original: cinco épocas e 15.000 passos

A cópia operacional tem os mesmos pesos do arquivo original e acrescenta somente o formato e o hash SHA-256 da topologia COO. O carregador rejeita por padrão checkpoints sem essa identidade ou com conexões divergentes.
...
A geração livre continua experimental e pode ser repetitiva ou pouco coerente. Os filtros de decodificação reduzem sintomas, mas a melhora estrutural depende de novo treinamento e aprovação pelos critérios generativos.
